const enUS = {
  ...
  stats: {
    ...
    source: "Sources: WHO, Covitel 2024 and Brazil Ministry of Health",
    items: [
      {
        suffix: ".8%",
        description: "of Brazilians diagnosed with anxiety (Covitel 2024)",
        source: "CNN Brasil / Covitel 2024",
      },
      {
        suffix: "st",
        description: "Brazil is the most anxious country in the world (WHO)",
        source: "WHO and Jornal da USP",
      },
      {
        suffix: "k",
        description: "work leaves for mental disorders in 2024 (+68%)",
        source: "Brazil Ministry of Social Security, 2024",
      },
      {
        suffix: "\u00d7",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "Yes. Everything is encrypted with AES-256 at rest and TLS 1.3 in transit. Only you can access your data thanks to Row Level Security. As this is sensitive health data, Brazil's LGPD (Art. 11) applies and processing is based on your explicit consent. Data stored in Brazil (Sao Paulo). Supervisory authority: ANPD.",
      },
      {
        question: "How does the voice diary work?",
        answer: "You speak 2 to 5 minutes a day about what you felt or experienced. The AI transcribes, analyzes emotions and gives you insights. Over time, you build a timeline that helps you see patterns. No data is shared with third parties without your consent.",
      },
      {
        question: "How much does Mirror cost?",
        answer: "You can try it for free with 3 entries per month. Paid plans (Essential R$ 24.90/month, Plus R$ 39.90/month) unlock unlimited entries, full history and AI patterns, ad-free. Cancel anytime.",
      },
      {
        question: "Can I delete my data?",
        answer: "Yes. There's a \u00abDelete everything\u00bb button that removes your data, as per the LGPD right to deletion (Art. 18). You can also export everything at any time.",
      },
      {
        question: "Does Mirror use my data to train AI?",
        answer: "No. Your recordings and entries are never used to train AI. Your data is only used to generate your insights, in line with the LGPD purpose-limitation principle.",
      },
      {
        question: "What is the minimum age to use Mirror?",
        answer: "18 years old. Given sensitive health data (LGPD Art. 11) and Brazil's Digital Statute of the Child and Adolescent (Law 15.211/2025), we adopt 18+ as the standard.",
      },
    ],
  },
  ...
  geoBlock: {
    ...
    availableNote: "\ud83c\udde7\ud83c\uddf7 Available in Brazil / Dispon\u00edvel no Brasil",
    close: "Close / Fechar",
  },
