const enGB = {
  ...
  // Stats Section
  stats: {
    titleBefore: "Portugal needs ",
    titleHighlight: "Mirror",
    subtitle: "The public health system can't keep up. 22% of Portuguese people live with mental health disorders. That's above the European average.",
    source: "Source: World Mental Health Survey \u2014 Harvard Medical School / NOVA Medical School, 2023",
    items: [
      {
        suffix: ".8%",
        description: "of 18-24 year-olds with mental health symptoms",
        source: "INE/INSA \u2014 National Health Survey, 2024",
      },
      {
        suffix: " days",
        description: "waiting for a psychology appointment in the public system",
        source: "Portuguese Psychologists Association, 2024",
      },
      {
        suffix: "%",
        description: "of Portuguese people under high stress",
