const ptPT = {
  ...
  stats: {
    ...
    subtitle: "O Brasil é o país mais ansioso do mundo. Cuidar da mente ainda é caro e difícil de aceder. O Mirror torna o autoconhecimento acessível, todos os dias.",
    source: "Fontes: OMS, Covitel 2024 e Ministerio da Saude do Brasil",
    items: [
      {
        suffix: ",8%",
      ...
      {
        suffix: "º",
        description: "o Brasil é o país mais ansioso do mundo (OMS)",
        source: "OMS e Jornal da USP",
      },
      {
        suffix: " mil",
        description: "afastamentos do trabalho por transtornos mentais em 2024 (+68%)",
        source: "Ministerio da Previdencia, 2024",
      },
      {
        suffix: "\u00d7",
