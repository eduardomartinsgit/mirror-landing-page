        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <ScrollReveal animation="fade-right" className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-10">
              <div className="group flex items-center gap-3 px-5 py-3 rounded-2xl bg-card/60 backdrop-blur-sm border border-border/50 hover:border-[#E91E8C]/50 transition-all duration-300">
              ...
              <div className="group flex items-center gap-3 px-5 py-3 rounded-2xl bg-card/60 backdrop-blur-sm border border-border/50 hover:border-[#00D4FF]/50 transition-all duration-300">
              ...
              <div className="group flex items-center gap-3 px-5 py-3 rounded-2xl bg-card/60 backdrop-blur-sm border border-border/50 hover:border-[#7B2FBF]/50 transition-all duration-300">
